...
import com.example.services.Adapter.CommentAdapter
...
class CommentsActivity : AppCompatActivity() {
    ...
    private var commentList: MutableList<com.example.services.Model.Comment>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        post_comment.setOnClickListener(View.OnClickListener {
            ...
            {
                Toast.makeText(this@CommentsActivity, "Say Something", Toast.LENGTH_LONG).show()
            }
            else
            {
                addComment()
        ...
        commentsRef.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(p0: DataSnapshot)
            {
                if(p0.exists())
                {
                    ...
                    {
                        val comment = snapshot.getValue(com.example.services.Model.Comment::class.java)
